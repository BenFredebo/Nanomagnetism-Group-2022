...
Filename = "Mx_6860.txt"; % change this depending on wanted input
...
datalayer = "Layer 3" ;  %Input string is used below 
...
figure()
contourf(Xplot,Yplot,TopDense2, 10, "LineColor", 'none'); % also just contour
...
% plots a btter version with quiver plot

figure()
contourf(Xplot,Yplot,TopDense2, 16, "LineColor", 'none'); % also just contour
